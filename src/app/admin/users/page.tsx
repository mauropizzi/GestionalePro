...
export default function AdminUsersPage() {
  ...
  const hasAccess = profile?.role === "super_admin" || profile?.role === "amministrazione";
  ...
  return (
    <DashboardLayout>
      <div className="flex flex-col items-center justify-center h-full text-center">
        <h1 className="text-4xl font-bold mb-4">Gestione Utenti</h1>
        <p className="text-lg text-muted-foreground">
          Qui potrai gestire gli account utente, cambiare i livelli di accesso, resettare le password e accettare nuove registrazioni.
        </p>
