...
interface NetworkOperator {
  ...
  created_at: string;
  updated_at: string;
  clienti?: { ragione_sociale: string } | null; // Per mostrare la ragione sociale del cliente
}
...
export default function OperatoriNetworkPage() {
  ...
  const filteredOperators = operators.filter((operator) =>
    ...
    operator.clienti?.ragione_sociale?.toLowerCase().includes(searchTerm.toLowerCase())
  );
    ...
    <DashboardLayout>
      <div className="container mx-auto py-8">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-4xl font-bold">Gestione Operatori Network</h1>
              ...
              {filteredOperators.length === 0 && !loading ? (
                ...
                filteredOperators.map((operator) => (
                  <TableRow key={operator.id}>
                    ...
                    <TableCell>{operator.clienti?.ragione_sociale || "N/A"}</TableCell>
