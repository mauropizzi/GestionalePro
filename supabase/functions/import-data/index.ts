...
// Import utility functions from the new modular utils file
import { checkExistingRecord, validateForeignKeys, fetchReferenceData } from './lib/utils.ts';

// Import mappers from the new modular mappers directory
import { mapClientData } from './lib/mappers/client-mapper.ts';
import { mapFornitoreData } from './lib/mappers/fornitore-mapper.ts';
import { mapOperatoreNetworkData } from './lib/mappers/operatore-network-mapper.ts';
import { mapPersonaleData } from './lib/mappers/personale-mapper.ts';
import { mapProceduraData } from './lib/mappers/procedura-mapper.ts';
import { mapPuntoServizioData } from './lib/mappers/punto-servizio-mapper.ts';
import { mapRubricaClientiData } from './lib/mappers/rubrica-clienti-mapper.ts';
import { mapRubricaFornitoriData } from './lib/mappers/rubrica-fornitori-mapper.ts';
import { mapRubricaPuntiServizioData } from './lib/mappers/rubrica-punti-servizio-mapper.ts';
import { mapTariffaData } from './lib/mappers/tariffa-mapper.ts';
