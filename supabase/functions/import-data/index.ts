...
import { mapRichiestaServizioData } from './mappers/richiesta-servizio-mapper.ts';
import { mapRichiesteServizioOrariGiornalieriData } from './mappers/richieste-servizio-orari-giornalieri-mapper.ts';
...
const dataMappers: { [key: string]: (rowData: any) => any } = {
  ...
  richieste_servizio: mapRichiestaServizioData,
  richieste_servizio_orari_giornalieri: mapRichiesteServizioOrariGiornalieriData,
};
