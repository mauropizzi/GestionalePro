// @ts-nocheck
// supabase/functions/import-data/utils/mappers/richiesta-servizio-mapper.ts
import { getFieldValue, toString, toNumber, toDateString, isValidUuid } from '../data-mapping.ts';
import { SERVICE_TYPES, INSPECTION_TYPES, APERTURA_CHIUSURA_TYPES } from '../../../src/lib/richieste-servizio-utils.ts'; // Import constants
