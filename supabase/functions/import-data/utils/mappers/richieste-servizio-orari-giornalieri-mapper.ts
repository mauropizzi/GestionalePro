// @ts-nocheck
// supabase/functions/import-data/utils/mappers/richieste-servizio-orari-giornalieri-mapper.ts
import { getFieldValue, toString, toBoolean, isValidUuid } from '../data-mapping.ts';
import { daysOfWeek } from '../../../src/lib/richieste-servizio-utils.ts'; // Import daysOfWeek
